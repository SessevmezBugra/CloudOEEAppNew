sap.ui.define([
	...
	return BaseComponent.extend("workerapp.components.oeeapp.Component", {
		...
		init: async function() {
			...
			// 	if (!this.keycloak.authenticated || this.keycloak.isTokenExpired() || !(this.keycloak.hasRealmRole("ORGANIZER") || this.keycloak.hasRealmRole("CLIENT_MANAGER") || this.keycloak.hasRealmRole("PLANT_MANAGER") || this.keycloak.hasRealmRole("OPERATOR"))) {
